...
const TimeBar = () => {
    ...
    return (
        ...
        <div
            className={`bg-black text-white h-10 w-full fixed top-0 z-20 transition-all duration-500 ease-in-out hidden md:block ${visible ? 'translate-y-0' : '-translate-y-full'
                }`}
        >
